...
import org.adfenp.cinealert.dao.RateFilmRepo;
...
import org.adfenp.cinealert.model.RateFilm;
...
public class RateFilmsService {
	...
	public MessagesResponse handleRateFilm(String username,Long filmID, RateFilm rateFilm) {
		...
		return new MessagesResponse("FAIL TO RATE", "You must login for rate a movie" );
	}
